#!/usr/bin/env python3
"""Replace navigation with consistent links across all pages"""
...
STANDARD_NAV_ITEMS = '''<li><a href="scaleup-services-design.html">Services</a></li>
                    <li><a href="scaleup-about-design.html">About</a></li>
                    <li><a href="scaleup-case-studies-design.html">Case Studies</a></li>
                    <li><a href="scaleup-contact-design.html">Contact</a></li>
                    <li><a href="scaleup-contact-design.html" class="text-gold" style="color:#D4A853;">Get Started</a></li>'''
...
def fix_page(filename):
    ...
    # Find and replace nav ul contents
    # Pattern matches <nav>...<ul>...</ul>...</nav>
...
def main():
    print("=" * 60)
    print("Replacing Navigation with Standard Links")
    print("=" * 60)
