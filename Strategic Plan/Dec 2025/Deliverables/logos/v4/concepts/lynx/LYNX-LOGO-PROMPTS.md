# ScaleUp Ventures - THE LYNX Logo Prompts
...
## Symbol Meaning
The lynx was revered as "the keeper of secrets" - seeing hidden truths others miss. Associated with Lynceus from Greek mythology who could see through the earth itself. Distinctive tufted ears, intense piercing eyes, angular face. "Sees through darkness and deception - detects what others miss."
...
2. Select "Gemini 2.0 Flash Experimental" or image generation model
3. Copy and paste each prompt below
4. Download the generated images

### Option 2: API (When Quota Resets)
Run the script: `node generate-lynx-logos.js`

---

## PROMPT 1: MINIMAL - PIERCING EYES ONLY (Most Abstract)
...
Create a MINIMAL, ABSTRACT logo for "ScaleUp Ventures" featuring only the PIERCING EYES of a lynx.
...
## PROMPT 2: PROFILE HEAD WITH TUFTED EARS (Medium Detail)
...
Create a SOPHISTICATED PROFILE logo for "ScaleUp Ventures" featuring a lynx head in profile, emphasizing the distinctive tufted ears.
...
## PROMPT 3: FULL FRONT-FACING HEAD WITH INTENSE STARE (Most Detailed)
...
Create a POWERFUL FRONT-FACING logo for "ScaleUp Ventures" featuring a full lynx head looking directly at the viewer with an intense, knowing stare.
...
## Summary JSON Output Location
When successfully generated, images and summary will be saved to:
`/Users/calvinwilliamsjr/Personal AI Enablement/My Apps/ceo/Strategic Plan/Dec 2025/Deliverables/logos/v4/concepts/lynx/`

## Files to Generate
1. `lynx-01-minimal-eyes.png` - Abstract piercing eyes only
2. `lynx-02-profile-tufted.png` - Profile view with tufted ears
3. `lynx-03-frontal-intense.png` - Front-facing intense stare

---

*Generated: December 31, 2025*
*Brand: ScaleUp Ventures*
*Symbol: The Lynx - Keeper of Secrets*
