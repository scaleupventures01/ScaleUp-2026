# ScaleUp Ventures - Ascending Bars Logo Prompts
## Ready to paste into Google AI Studio (https://aistudio.google.com)

**Instructions:**
1. Go to https://aistudio.google.com
2. Select a model that supports image generation (gemini-2.0-flash-exp or gemini-2.5-flash-image)
3. Enable "Generate Image" in the settings
4. Copy each prompt below and paste it into the chat
5. Download the generated image and save to the logos folder
...
Save the downloaded images to:
- `/Users/calvinwilliamsjr/Personal AI Enablement/My Apps/ceo/Strategic Plan/Dec 2025/Deliverables/logos/bars-1.png`
- `/Users/calvinwilliamsjr/Personal AI Enablement/My Apps/ceo/Strategic Plan/Dec 2025/Deliverables/logos/bars-2.png`
- `/Users/calvinwilliamsjr/Personal AI Enablement/My Apps/ceo/Strategic Plan/Dec 2025/Deliverables/logos/bars-3.png`

Then update bars-summary.json to reflect successful generation.
